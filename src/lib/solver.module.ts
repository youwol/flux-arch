...
import { Flux, BuilderView, ModuleFlux, Pipe, Schema, Property, freeContract } from '@youwol/flux-core'
...
export namespace ModuleSolver {
    ...
    export class Module extends ModuleFlux {
        ...
        solve( scene: ArcheFacade.Scene, config: PersistentData, context: any) {
