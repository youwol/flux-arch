...
import { Flux, BuilderView, ModuleFlow, Pipe, Schema, RenderView, createHTMLElement, SideEffects } from '@youwol/flux-lib-core'
import { Tree } from '@youwol/flux-lib-views'
import { AssetsFilesystem } from '@youwol/flux-pack-youwol'
...
export namespace ProjectView {
    ...
    export class Module extends ModuleFlow implements SideEffects{
        ...
        constructor(params) {
            ...
            this.addInput("input", inputDescription, this.initialize )  
        }
    ...
    function renderHtmlElement(mdle: Module) {
        ...
        mdle.view = new Tree.View<ArcheNode>(treeData$, { actions: getActions, headerView: headerView }, mdle.subscriptionsView)
