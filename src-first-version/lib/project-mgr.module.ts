...
import { Property, Flux, BuilderView, ModuleFlow, Pipe, Schema, SideEffects, Project } from '@youwol/flux-lib-core'
...
export namespace ProjectMgr {
    ...
    export class Module extends ModuleFlow implements SideEffects {
        ...
        constructor(params) {
            ...
            this.addInput("inputState", inputDescription, this.newSession ) 
        }
